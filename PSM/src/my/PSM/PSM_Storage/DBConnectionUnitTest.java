...
public class DBConnectionUnitTest {
	...
	public void testStoreClassInfo1() throws SQLException {
		...
		assertEquals("Successful class storage", 0, result);
	}
	...
	public void testStoreClassSched1() throws SQLException {
		...
		assertEquals("Successful schedule storage", 0, resultMock);
	}
	...
	public void testStoreClassSched2() throws SQLException {
		...
		assertEquals("Successful schedule storage", -1, resultMock);
	}
	...
	public void testClearDatabase1() throws SQLException {
		...
		assertEquals("Database purge test success", null, resultMock);
	}
...
//              + "am_or_pm VARCHAR (5),"
		...
		assertEquals("Database table creation test success", 0, db.createClassTable());
	}
